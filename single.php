...
<?php while (have_posts()) : the_post(); ?>
    <section class="container u-relative" itemscope="itemscope" itemtype="http://schema.org/Article">
        ...
        <?php
        // link to status post format archive page
        if (get_post_format() == 'status') : ?>
            <div class="status--archiveLink">
                <a href="<?php echo get_post_format_link('status'); ?>" class="status--link" title="<?php _e('View all status posts', 'Berry'); ?>">
                    <?php _e('View all status posts', 'Berry'); ?>
                </a>
            </div>
        <?php endif; ?>
        <?php
