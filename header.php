    ...
    <div class="surface-content">
        <header class="bHeader">
            <?php if (has_nav_menu('berry')) : ?>
                <div class="bNav">
                    <?php wp_nav_menu(array('theme_location' => 'berry', 'menu_class' => 'bNav--list', 'container' => 'ul')); ?>
                </div>
            <?php endif; ?>
            <div class="container bHeader--content">
                <h1 class="site-title">
                ...
                <div class="bar">
                    ...
                    <?php if ($berrySetting->get_setting('twitter')) : ?>
                        <a href="<?php echo $berrySetting->get_setting('twitter'); ?>" target="_blank" class="socialIcon" title="Twitter">
                    ...
                    <?php endif; ?>
                    <?php if ($berrySetting->get_setting('telegram')) : ?>
                        <a href="<?php echo $berrySetting->get_setting('telegram'); ?>" target="_blank" class="socialIcon" title="Telegram">
                    ...
                    <?php if ($berrySetting->get_setting('rss')) : ?>
                        <a href="<?php echo get_feed_link() ?>" target="_blank" style="margin-left:auto;" class="socialIcon" title="RSS">
