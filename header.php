            ...
            <div class="container">
                ...
                <div class="bar">
                    ...
                    <?php if ($berrySetting->get_setting('twitter')) : ?>
                        <a href="<?php echo $berrySetting->get_setting('twitter'); ?>" target="_blank" class="socialIcon">
                    ...
                    <?php if ($berrySetting->get_setting('telegram')) : ?>
                        <a href="<?php echo $berrySetting->get_setting('telegram'); ?>" target="_blank" class="socialIcon">
                    ...
                    <?php if ($berrySetting->get_setting('rss')) : ?>
                        <a href="<?php echo get_feed_link() ?>" target="_blank" style="margin-left:auto;" class="socialIcon">
